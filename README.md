This is the week 6 homework assignment. It's the first assignment where we retrieved data from another application's API. The third party API used here was OpenWeather API.
